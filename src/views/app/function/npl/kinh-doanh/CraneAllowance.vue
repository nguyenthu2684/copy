                ...
                <div class="d-flex flex-wrap">
                  <b-col lg="4" class="pl-0">
                    <b-row>
                      ...
                      <b-col lg="6">
                        <b-form-group
                          label="Số tiền phụ cấp khi chở hàng không cẩu"
                        >
                          <b-form-input
                            v-model="dataForm['noCraneAllowance']"
                            :disabled="isEdit || isAdd ? false : true"
                            class="text-right"
                          ></b-form-input>
                        </b-form-group>
                      ...
                      <b-col lg="6">
                        <b-form-group
                          label="Số tiền cẩu trên 10 lần trong 1 ngày/địa điểm"
                        >
                          <b-form-input
                            v-model="dataForm['craneMoreThan10Times']"
                            :disabled="isEdit || isAdd ? false : true"
                            class="text-right"
                          ></b-form-input>
                        </b-form-group>
                  ...
                  <b-col lg="3" class="pl-0 pl-lg-3">
                    <div class="style-special">
                      *Số lần cẩu trong 1 ngày/địa điểm
                    </div>
                    <b-table
                      :items="detailCraneRender"
                      :fields="tempData.fieldsDetailCrane"
                      :bordered="true"
                      show-empty
                      head-variant="light"
                    >
                      <template #cell(time)="row">
                        <template v-if="row.item.isNewRow">
                          <b-form-input v-model="row.item.time"></b-form-input>
                        </template>
                      ...
                      <template #cell(amount)="row">
                        ...
                        <template v-else>{{ row.item.amount }}</template>
                      </template>
                    </b-table>
                  </b-col>
                </div>
...
import tempData from "@/data/modules/npl/proposedCraneAllowance(1.5)";
...
export default {
  ...
  data() {
    return {
      ...
      keyComponent: "basic",
      //title-options
      currentTitle: 'Định mức phụ cấp cẩu' ?? null,
  ...
  watch: {
    currentTab() {
      const arr = [...this.tempData.dataDetailCrane];
      this.detailCraneRender = arr;
    },
  },
  methods: {
    handlePrint() {
