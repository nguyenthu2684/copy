                ...
                <div class="d-flex flex-wrap">
                  <b-col lg="6" class="pl-0">
                    <b-row>
                      ...
                      <b-col lg="4">
                        <b-form-group label="Số tiền phụ cấp/chuyến">
                          <b-form-input
...
export default {
  ...
  data() {
    return {
      ...
      keyComponent: "basic",
      //title-options
      currentTitle: 'Định mức phụ cấp hàng cont cặp cổ, quá tải' ?? null,
      ...
      ////////
      tempData: tempData,
      title: "phụ cấp hàng cont cặp cổ, quá tải",
      isLock: false,
      perPageTable2: 10,
      currentPageTable2: 1,
      perPageTable3: 10,
      ...
      titleOption: [
        {
          id: 0,
          label: "Định mức phụ cấp hàng cont cặp cổ, quá tải",
        },
      ],
      detailCraneRender: [],
    };
